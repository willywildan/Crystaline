...
<html lang="en">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"></script>
    ...
    <link href="<?php echo base_url();?>css/style-dinkes.css" rel="stylesheet">
             ...
             <div class="left">
               <div class="content">
                 ...
                 <form action="register.php" method="POST"  enctype="multipart/form-data"> 
                  <input type="text" name="level" id="level" value="dinkes" hidden >
              ...
              <div class="right">
                <div class="content">
                  ...
                  <form action="<?php echo site_url('login/ceklogin')?>" method="POST">
                    <div class="form-group">
                      <div class="form-group">
                        <input type="text" name="lvl" id="lvl" value="dinkes" hidden >
